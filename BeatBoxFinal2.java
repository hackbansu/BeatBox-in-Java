...
public class BeatBoxFinal2 {
	...
	public void buildGui() {
		...
		BorderLayout listPanelLayout = new BorderLayout(10, 10);
		JPanel listPanel = new JPanel(listPanelLayout);
		this.userMessage = new JTextField();
		this.userMessage.setFont(new Font("TimesNewRoman", Font.BOLD, 16));
		listPanel.add(this.userMessage, BorderLayout.NORTH);
		...
		listPanel.add(theList, BorderLayout.CENTER);
		this.incomingList.setListData(this.listVector);

		listPanel.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
		buttonBox.add(listPanel);
